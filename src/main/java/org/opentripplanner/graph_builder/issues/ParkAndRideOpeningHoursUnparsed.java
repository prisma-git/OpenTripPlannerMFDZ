...
public class ParkAndRideOpeningHoursUnparsed implements DataImportIssue {
  ...
  public static final String FMT =
    "Park and ride '%s' (%s) has an invalid opening_hours value, it will always be open: %s";
  public static final String HTMLFMT =
    "Park and ride <a href='%s'>'%s' (%s)</a> has an invalid opening_hours value, it will always be open: <code>%s</code>\"";
